...
interface RepairCatalogTableProps {
  ...
  onEdit: (entry: RepairCatalogEntry) => void
  onDelete: (entry: RepairCatalogEntry) => void
  isLoading?: boolean
}

export function RepairCatalogTable({ entries, onEdit, onDelete, isLoading }: RepairCatalogTableProps) {
